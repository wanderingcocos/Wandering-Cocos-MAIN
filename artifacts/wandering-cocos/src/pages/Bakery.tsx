...
function RightPanel({ siteMode }: { siteMode: string }) {
  ...
  const links = [
    ...
    },
    {
      ...
      action: () =>
        document
          .getElementById("way-of-coco")
          ?.scrollIntoView({ behavior: "smooth" }),
    },
  ];

  return (
    <div className="fixed right-0 top-1/2 -translate-y-1/2 flex flex-col items-end gap-7 pr-4 z-30 hidden md:flex">
      {links.map((l) => (
        <button
          key={l.label}
          onClick={l.action}
          ...
          style={{
            ...
            border: "none",
            cursor:
              l.label === "Pre-order" && l.disabled ? "default" : "pointer",
            padding: 0,
          ...
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLButtonElement).style.color = l.bold
              ? "#0f2419"
              : "rgba(15,36,25,0.52)";
          }}
        >
      ...
      >
        {cardBakes.map((b, i) => (
          <div
            key={i}
            style={{
              borderBottom: "0.5px solid rgba(15,36,25,0.08)",
              cursor: "pointer",
            }}
          ...
          >
            ...
            >
              <img
                src={
                  bakes[i % bakes.length]?.img || `${BASE}/images/woc-bg.png`
                }
                alt={b.name}
                style={{
                  width: "100%",
            ...
            >
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "linear-gradient(to bottom, rgba(0,0,0,0) 55%, rgba(0,0,0,0.58) 100%)",
                }}
              />
            ...
            >
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "linear-gradient(to bottom, rgba(0,0,0,0) 55%, rgba(0,0,0,0.52) 100%)",
                }}
              />
...
function HowItWorks() {
  return (
    <section
      id="way-of-coco"
      style={{ background: "#0f2419", padding: "52px 80px 52px 36px" }}
    >
      <span
        style={{
          fontSize: 8,
  ...
  return (
    <section
      style={{
        ...
        borderTop: "0.5px solid rgba(15,36,25,0.08)",
      }}
    >
      <span
        style={{
      ...
      >
        {boxes.map((box, i) => (
          <div
            key={i}
            style={{
              border: "0.5px solid rgba(15,36,25,0.1)",
          ...
          >
            ...
            {(card as any).has90 && (
              <div style={{ display: "flex", gap: 12, marginTop: 8 }}>
                {[
                  {
                    pct: "90%",
                    label: "Clean. Move well.\nEat with awareness.",
                  },
                  {
                    pct: "10%",
                    label: "Indulge. And when\nyou do, exceptionally.",
                  },
                ].map(({ pct, label }) => (
                  <div
                    key={pct}
            ...
            {(card as any).hasIngredients && (
              ...
              >
                {[
                  {
                    name: "Digitally-Milled Flours",
                    note: "100% natural, additive-free. Superior nutrition baked into every bite.",
                  },
                  {
                    name: "Botanical Nectars",
                    note: "Dates, Coconut Sugar, raw Wildflower Honey. Sweetness in its most primal form.",
                  },
                  {
                    name: "Noble Fats",
                    note: "Cold-extracted and nutrient-dense. Sourced for the body's rhythm.",
                  },
                ].map(({ name, note }) => (
                  <div key={name}>
                    <span
      ...
      >
        {addons.map((addon) => {
          const waText = encodeURIComponent(
            `Hi! I'd like to add ${addon.title} (${formatPrice(addon.pricePaise)}) to my order.`,
          );
